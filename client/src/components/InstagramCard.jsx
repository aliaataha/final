...
const[hover,setHover]=useState(false)
  return (
      <div  className=' insta-card lg:w-[calc((100%-4rem)/5)] md:w-[calc((100%-3rem)/4)] w-[calc((100%-2rem)/3)]  rounded-3xl overflow-hidden relative 'onMouseEnter={()=>setHover(true)}  onMouseLeave={()=>setHover(false)}>
