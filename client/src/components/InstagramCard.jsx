...
const[hover,setHover]=useState(false)
  return (
      <div  className=' insta-card lg:w-[calc((100%-6rem)/5)] md:w-[calc((100%-4.5rem)/4)] w-[calc((100%-3rem)/3)] h-[30vh] rounded-4xl overflow-hidden relative 'onMouseEnter={()=>setHover(true)}  onMouseLeave={()=>setHover(false)}>
