...
export default function ShopCard({numShopCard,color,img}) {
  return (
      <div className={`${numShopCard} lg:w-[calc((100%-1rem)/2)] w-[calc((100%)/2)]  h-70 rounded-2xl relative overflow-hidden mb-2 flex items-center justify-center  `} style={{ backgroundColor: color }} >
