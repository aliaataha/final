  ...
  return (
      <div className={`${numShopCard} lg:col-span-6 col-span-12 grid grid-cols-12  gap-[1.5rem] h-70 rounded-2xl relative overflow-hidden mb-2  `} style={{ backgroundColor: color }} >
          ...
          <div className="content col-span-6 relative z-10 pt-6">
              ...
              <p className=' text-[var(--medium-gray)] lg:grid md:grid-cols-12  lg:text-[1rem] md:text-[1rem] text-[.7rem] py-[1rem] ' style={{ wordSpacing: '0.2rem' ,lineHeight: '2rem' }}><span className='lg:col-span-12 md:col-span-12'>The flavour of</span> <span className='lg:col-span-12 md:col-span-12'>something special</span></p>
              <Button/>
          </div>
     </div>
  )
